...
interface BitrielGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class BitrielGovernance extends BaseContract {
  ...
  interface: BitrielGovernanceInterface;
